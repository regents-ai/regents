defmodule AshPlatformWeb do
  ...
  def static_paths,
    do:
      ~w(assets fonts images api-contract.openapiv3.yaml apple-touch-icon.png favicon.ico favicon-32.png favicon-192.png favicon.svg mark.png robots.txt llms.txt)
  ...
  def live_view do
    quote do
      use Phoenix.LiveView, layout: {AshPlatformWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: AshPlatformWeb.Router,
        statics: AshPlatformWeb.static_paths()
    end
  end
